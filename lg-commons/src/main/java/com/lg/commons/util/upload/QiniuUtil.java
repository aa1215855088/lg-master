...
public class QiniuUtil implements UploadUtil {
     ...
     */
    @Override
    public String uploadFile(MultipartFile multipartFile) throws BusinessException {
     ...
     */
    @Override
    public String uploadFile(String filePath, MultipartFile multipartFile) throws BusinessException {
        byte[] bytes = getBytesWithMultipartFile(multipartFile);
     ...
     */
    @Override
    public String uploadFile(MultipartFile multipartFile, String fileName) throws BusinessException {
        byte[] bytes = getBytesWithMultipartFile(multipartFile);
     ...
     */
    @Override
    public String uploadFile(MultipartFile multipartFile, String fileName, String filePath) throws BusinessException {
        byte[] bytes = getBytesWithMultipartFile(multipartFile);
     ...
     */
    @Override
    public String uploadFile(String filePath, File file) throws BusinessException {
     ...
     */
    @Override
    public String uploadFile(File file, String fileName) throws BusinessException {
     ...
     */
    @Override
    public String uploadFile(File file, String fileName, String filePath) throws BusinessException {
     ...
     */
    @Override
    public String uploadFile(byte[] data) throws BusinessException {
     ...
     */
    @Override
    public String uploadFile(String filePath, byte[] data) throws BusinessException {
     ...
     */
    @Override
    public String uploadFile(byte[] data, String fileName) throws BusinessException {
     ...
     */
    @Override
    public String uploadFile(byte[] data, String fileName, String filePath) throws BusinessException {
        String key = preHandle(fileName, filePath);
        Response response;
        try {
    ...
    private String preHandle(String fileName, String filePath) throws BusinessException {
        if (StringUtils.isNotBlank(fileName) && !fileName.contains(".")) {
            throw new BusinessException("文件名必须包含尾缀");
        }
        if (StringUtils.isNotBlank(filePath) && !filePath.startsWith("/")) {
            throw new BusinessException("前缀必须以'/'开头");
        }
    ...
    private String getUrlPath(Response response) throws BusinessException {
        if (!response.isOK()) {
