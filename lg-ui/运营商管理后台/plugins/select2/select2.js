...
(function ($, undefined) {
     ...
     * two options have to be defined in product for the tokenizer to work.
     *
     * @param input text product has typed so far or pasted into the search field
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function (opts) {
            ...
            if ($.isFunction(this.opts.initSelection)) {
                ...
                // if the product has provided a function that can set selection based on the value of the source element
        ...
        updateResults: function (initial) {
            var search = this.search,
                ...
                // sequence number used to drop out-of-product responses
                queryNumber;
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        opening: function () {
            ...
            // initializes search's value with nextSearchTerm (if defined by product)
            // ignore nextSearchTerm if the dropdown is opened by the product pressing a letter
            if(this.search.val() === "") {
            ...
            if (opts.element.get(0).tagName.toLowerCase() === "select") {
                ...
                opts.initSelection = opts.initSelection || function (element, callback) {
                    ...
                    opts.query({
                        ...
                        callback: !$.isFunction(callback) ? $.noop : function() {
                            // reorder matches based on the product they appear in the ids array because right now
                            // they are in the product in which they appear in data array
                            var ordered = [];
