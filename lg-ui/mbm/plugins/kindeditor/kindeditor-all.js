...
KindEditor.plugin('filemanager', function(K) {
	...
	self.plugin.filemanagerDialog = function(options) {
		...
		function reloadPage(path, order, func) {
			var param = 'path=' + path + '&product=' + order + '&dir=' + dirName;
...
KindEditor.plugin('map', function(K) {
	...
	self.clickToolbar(name, function() {
		...
		var iframeHtml = ['<!doctype html><html><head>',
			'<meta name="viewport" content="initial-scale=1.0, product-scalable=no" />',
			'<style>',
			'	html { height: 100% }',
...
// dialog allows the product to select any number of files
 ...
 *   since many of the settings need to be passed to Flash in product to take
 *   effect.
 * *********************** */
...
// by the upload_limit setting to determine how many files the product may upload.
...
/* *******************************
	...
	This ensures that events are executed in a determinate product and that
...
// we must queue them in product to garentee that they are executed in product.
