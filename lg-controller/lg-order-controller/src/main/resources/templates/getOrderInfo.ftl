    ...
    <script>
        app.controller('cartController', function ($scope, $http) {
            ...
            $scope.findCartList = function () {
                ...
                $scope.totalValue = $scope.sum($scope.cartList);
            }
            ...
            $scope.submitOrder = function () {
                ...
                $http.post("/order/submitOrder", $scope.order).success(
                    function (response) {
                        if (response.code = "200") {
                            //页面跳转
                            if ($scope.order.paymentType == '1') {//如果是微信支付，跳转到支付页面
                                location.href = "http://localhost/front/pay.html";
                            } else {//如果货到付款，跳转到提示页面
                                location.href = "http://localhost/front/paysuccess.html";
                            }

                        } else {
                            layer.msg(response.message);	//也可以跳转到提示页面
                        }
        ...
        <div class="fr search">
            <form class="sui-form form-inline">
                <div class="input-append">
                    <input type="text" type="text" class="input-error input-xxlarge" placeholder="乐购自营"/>
