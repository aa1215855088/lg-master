...
public class CartServiceImpl extends ServiceImpl<TbItemMapper, TbItem> implements CartService {
    ...
    public List<Cart> addGoodsToCartList(List<Cart> cartList, Long itemId, Integer num) {
        ...
        TbItem item=this.baseMapper.selectOne(new QueryWrapper<TbItem>().eq("id",itemId));
        if (item==null){
